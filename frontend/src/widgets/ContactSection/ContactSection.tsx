      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 animate-fade-in-up">
            ...
            {/* Tarjeta de Teléfono */}
            <div className="bg-[#16130c] border border-[#2a2415] rounded-2xl p-6 flex items-center gap-5 shadow-lg">
            ...
            {/* Mapa de Google Real */}
            <div className="h-56 rounded-2xl border border-[#2a2415] overflow-hidden shadow-lg relative mt-2">
              <iframe 
          ...
          <div className="lg:col-span-7 animate-fade-in-up [animation-delay:200ms] h-full">
            <div className="bg-[#16130c] p-8 md:p-10 rounded-3xl border border-[#2a2415] shadow-2xl h-full flex flex-col justify-center">
