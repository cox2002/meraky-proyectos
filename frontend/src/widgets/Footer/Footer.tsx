...
export default function Footer() {
  return (
    <footer className="bg-[#050402] border-t border-white/5 pt-16 pb-8 relative z-50">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
        ...
        <div className="flex flex-col">
          <Link href="/" className="mb-6 flex items-center">
            <span className="font-display font-black text-3xl tracking-tight text-white">
              MERA<span className="text-[#FACC15]">KY</span>
            </span>
          </Link>
          ...
          <div className="flex gap-4">
            <a href="#" className="bg-[#110e08] border border-white/10 p-2.5 rounded-full text-white/70 hover:text-[#FACC15] hover:border-[#FACC15]/30 transition-all">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/60">
            <li><Link href="#servicios" className="hover:text-[#FACC15] transition-colors">Mamparas</Link></li>
            <li><Link href="#servicios" className="hover:text-[#FACC15] transition-colors">Espejos</Link></li>
            <li><Link href="#servicios" className="hover:text-[#FACC15] transition-colors">Ventanas</Link></li>
            <li><Link href="#servicios" className="hover:text-[#FACC15] transition-colors">Fachadas</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/60">
            ...
            <li className="flex items-center gap-3">
              ...
              <span>cotizaciones@merakyproyectos.com</span>
            </li>
      ...
      {/* Barra Inferior */}
      <div className="max-w-7xl mx-auto px-6 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-xs">
        <p>&copy; {new Date().getFullYear()} MERAKY. Todos los derechos reservados.</p>
        <p>Desarrollado por <span className="border border-white/20 px-2 py-1 rounded text-white/60">Meraky Proyectos</span></p>
        <div className="flex gap-4">
