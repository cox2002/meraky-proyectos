    ...
    <main className="min-h-screen w-full bg-[#0c0a07] overflow-hidden flex flex-col">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 flex items-center min-h-screen">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-[#0c0a07]/85"></div>
        </div>
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <ScrollReveal staggerChildren={0.15} direction="left" className="flex flex-col items-start">
              <ScrollRevealItem>
                <div className="inline-flex items-center gap-2 bg-[#16130c]/90 border border-[#FACC15]/30 px-4 py-1.5 rounded-full text-xs font-semibold text-[#FACC15] mb-6 uppercase tracking-wider">
              ...
              <ScrollRevealItem>
                <Heading level="h1" className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
                  Mantenimiento <br />
                  <span className="text-[#FACC15] drop-shadow-[0_0_15px_rgba(250,204,21,0.2)]">Profesional</span> <span className="text-white/90">de Vidrios</span>
                </Heading>
              </ScrollRevealItem>
              ...
              <ScrollRevealItem className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 mb-10 w-full">
                <div className="flex items-center gap-2 text-white/90 text-sm font-medium">
                  <div className="w-5 h-5 bg-[#FACC15]/10 border border-[#FACC15]/40 rounded-full flex items-center justify-center text-[#FACC15]">
              ...
              <ScrollRevealItem className="flex flex-wrap items-center gap-4">
                <a href="#servicios" className="bg-[#FACC15] text-[#110e08] px-8 py-3.5 rounded-full font-bold shadow-[0_0_20px_rgba(250,204,21,0.3)] hover:shadow-[0_0_30px_rgba(250,204,21,0.5)] hover:-translate-y-1 transition-all flex items-center gap-2">
                  Ver Servicios
                ...
                <button onClick={() => handleWhatsApp()} className="bg-[#16130c]/80 text-white border border-[#2a2415] hover:border-[#FACC15]/50 px-8 py-3.5 rounded-full font-bold hover:bg-[#1f1a11] backdrop-blur-sm hover:-translate-y-1 transition-all flex items-center gap-2">
            ...
            <ScrollReveal direction="right" className="relative mt-8 lg:mt-0 flex flex-col items-center">
              <div className="relative w-full max-w-md md:max-w-lg lg:max-w-xl mx-auto rounded-[2.5rem] overflow-hidden border border-[#2a2415]/60 shadow-2xl bg-[#16130c]">
                ...
                <div className="absolute top-6 right-6 bg-[#FACC15] text-[#110e08] font-bold text-center flex flex-col justify-center items-center w-20 h-20 rounded-full shadow-2xl border-4 border-[#0c0a07] z-20">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-[#110e08]/90 backdrop-blur-md border border-[#FACC15]/30 p-5 rounded-2xl flex items-center justify-between shadow-2xl z-20">
                  <div>
                    ...
                    <span className="text-[#FACC15] text-xs font-semibold block mt-0.5">*Diagnóstico gratuito</span>
                  </div>
                  
                  <div className="flex flex-col items-end gap-2">
                    <button onClick={() => handleWhatsApp()} className="bg-[#FACC15] hover:bg-[#eab308] text-[#110e08] px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md">
                    ...
                    <div className="flex gap-2">
                      <a href="tel:+51929765802" className="p-2 bg-[#16130c] border border-[#2a2415] hover:border-[#FACC15]/40 rounded-xl text-[#FACC15] transition-colors" title="Llamar">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.94.725l.548 2.2a1 1 0 01-.321.988l-1.305.98a10.582 10.582 0 004.872 4.872l.98-1.305a1 1 0 01.988-.321l2.2.548a1 1 0 01.725.94V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                      </a>
                      <button onClick={() => handleWhatsApp()} className="p-2 bg-[#16130c] border border-[#2a2415] hover:border-emerald-500/40 rounded-xl text-emerald-500 transition-colors" title="WhatsApp">
      ...
      <section id="servicios" className="py-24 px-6 bg-[#110e08]/30 border-y border-[#2a2415]/50 relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            <span className="text-[#FACC15] font-bold uppercase tracking-widest text-xs mb-4 block">
              NUESTROS SERVICIOS
            </span>
            <Heading level="h2" className="text-4xl md:text-5xl font-extrabold text-white">
              Servicios de <span className="text-[#FACC15]">Mantenimiento</span>
            </Heading>
          ...
          <ScrollReveal staggerChildren={0.15} direction="up" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICIOS_MANTENIMIENTO.map((srv, idx) => (
              <div 
                key={idx}
                className="bg-[#16130c]/90 rounded-3xl overflow-hidden border border-[#2a2415]/70 hover:border-[#FACC15]/40 transition-all duration-500 flex flex-col h-full group hover:shadow-2xl hover:shadow-[#FACC15]/5"
              >
                ...
                <div className="relative h-60 w-full overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#110e08] via-transparent to-transparent z-10" />
                  
                  {/* Floating Icon */}
                  <div className="absolute top-4 left-4 w-10 h-10 bg-[#110e08]/90 backdrop-blur-sm border border-[#2a2415] rounded-xl flex items-center justify-center z-20">
                    {srv.icon}
                  </div>

                  {/* Floating Recommended pill */}
                  <span className="absolute bottom-4 right-4 bg-[#FACC15] text-[#110e08] text-[10px] font-bold px-3 py-1 rounded-full shadow-md z-20">
                    {srv.periodicity}
                  </span>
                </div>

                {/* Card Content */}
                <div className="p-6 md:p-8 flex flex-col flex-grow bg-[#16130c]">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {srv.tags.map((tag, sIdx) => (
                      <span key={sIdx} className="bg-[#110e08]/90 text-white/80 border border-[#2a2415] text-[11px] px-3 py-1.5 rounded-full font-medium">
                        {tag}
                      </span>
                    ))}
                    <span className="bg-[#110e08]/90 text-[#FACC15]/80 border border-[#FACC15]/20 text-[11px] px-3 py-1.5 rounded-full font-medium">
                      +3 más
                    </span>
                  </div>

                  {/* Actions */}
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#2a2415]/50">
                    <button 
                      onClick={() => handleWhatsApp(srv.title)}
                      className="text-xs font-bold text-[#FACC15] flex items-center gap-1 hover:underline"
                    >
                      Diagnóstico Gratis
                    ...
                    <button 
                      onClick={() => handleWhatsApp(srv.title)}
                      className="bg-gradient-to-r from-[#2a2415] to-[#110e08] text-[#FACC15] border border-[#FACC15]/20 hover:border-[#FACC15]/50 px-5 py-2.5 rounded-full text-xs font-bold shadow-md hover:shadow-lg transition-all hover:scale-105"
                    >
      ...
      <section className="py-24 px-6 bg-[#0c0a07]">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-extrabold text-white">
              ¿Por qué hacer <span className="text-[#FACC15]">Mantenimiento?</span>
            </Heading>
          </ScrollReveal>
          ...
          <ScrollReveal staggerChildren={0.12} direction="up" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {VENTAJAS.map((item, idx) => (
              <div 
                key={idx}
                className="bg-[#110e08]/90 border border-[#2a2415] rounded-3xl p-6 flex flex-col items-center text-center shadow-lg hover:border-[#FACC15]/30 hover:scale-105 transition-all duration-300"
              >
                <div className="w-16 h-16 bg-[#16130c] border border-[#2a2415] rounded-2xl flex items-center justify-center mb-6">
                  {item.icon}
                </div>
      ...
      <section className="py-24 px-6 bg-[#110e08]/30 border-t border-[#2a2415]/50">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            <span className="text-[#FACC15] font-bold uppercase tracking-widest text-xs mb-4 block">
              PROCESO
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-extrabold text-white">
              ¿Cómo <span className="text-[#FACC15]">Trabajamos?</span>
            </Heading>
          </ScrollReveal>
          ...
          <ScrollReveal staggerChildren={0.15} direction="up" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {PROCESO.map((step, idx) => (
              <div 
                key={idx}
                className="bg-[#16130c]/80 border border-[#2a2415] rounded-3xl p-6 flex flex-col items-start relative overflow-hidden"
              >
                <div className="w-10 h-10 bg-[#FACC15] text-[#110e08] text-lg font-black rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#FACC15]/20">
                  {step.step}
                </div>
          ...
          <ScrollReveal staggerChildren={0.1} direction="up" className="space-y-4">
            {FAQ.map((item, idx) => {
              ...
              return (
                <ScrollRevealItem 
                  key={idx} 
                  className="bg-[#110e08]/90 border border-[#2a2415] rounded-2xl overflow-hidden shadow-lg transition-all duration-300"
                >
                  <button
                    onClick={() => toggleFaq(idx)}
                    className="w-full px-6 py-5 flex items-center justify-between text-left gap-4 hover:bg-[#16130c]/50 transition-colors"
                  >
                    <span className="text-white font-bold text-base md:text-lg tracking-wide">{item.pregunta}</span>
                    <span className={`w-6 h-6 shrink-0 rounded-full bg-[#16130c] border border-[#2a2415] flex items-center justify-center text-[#FACC15] transition-transform duration-300 ${isOpen ? 'rotate-180' : 'rotate-0'}`}>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M19 9l-7 7-7-7"/></svg>
                    </span>
                  </button>
                  <div 
                    className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[250px] border-t border-[#2a2415]/40 opacity-100' : 'max-h-0 opacity-0'}`}
                  >
                    <div className="px-6 py-5 text-white/70 font-light text-sm md:text-base leading-relaxed bg-[#16130c]/20">
                      {item.respuesta}
                    </div>
                  </div>
                </ScrollRevealItem>
      ...
      {/* Bottom CTA Banner */}
      <section className="py-20 px-6 bg-[#0c0a07] border-t border-[#2a2415]/30">
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-[#1c170f] via-[#110e08] to-[#1c170f] border border-[#FACC15]/30 rounded-[2.5rem] p-8 md:p-12 text-center relative overflow-hidden shadow-2xl">
          
          {/* Alert Warning icon */}
          <div className="w-16 h-16 bg-[#FACC15]/10 border border-[#FACC15]/30 rounded-2xl flex items-center justify-center mx-auto mb-8 animate-pulse text-[#FACC15]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button 
              ...
              className="bg-[#FACC15] hover:bg-[#eab308] text-[#110e08] px-8 py-3.5 rounded-full font-bold shadow-lg transition-all flex items-center gap-2 hover:-translate-y-0.5"
            >
            ...
            <a 
              ...
              className="bg-[#16130c]/80 text-white border border-[#2a2415] hover:border-[#FACC15]/40 px-8 py-3.5 rounded-full font-bold hover:bg-[#1f1a11] backdrop-blur-sm transition-all flex items-center gap-2"
            >
