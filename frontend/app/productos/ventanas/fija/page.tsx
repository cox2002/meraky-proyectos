...
const INCLUYE = [
  "Máxima luminosidad",
  "Sin herrajes visibles",
  "Sin mantenimiento de herrajes",
...
const VENTAJAS = [
  { 
    ...
    desc: "Al carecer de marcos intermedios y herrajes de apertura, el cristal ocupa el 100% de la superficie, maximizando la claridad." 
  },
  { 
    title: "Diseño Minimalista", 
    desc: "Perfil de aluminio ultradelgado o incluso sin perfiles visibles (estilo frameless) para una apariencia limpia y sofisticada." 
  },
  { 
    title: "Aislamiento Superior", 
    desc: "Al ir sellada estructuralmente al marco, ofrece la mayor eficiencia térmica y acústica de toda la gama." 
  },
  { 
    title: "Mantenimiento Cero", 
    desc: "Sin bisagras, rieles ni manijas propensas a desgaste. Solo requiere la limpieza periódica del vidrio." 
  }
];
...
const DATOS = [
  { 
    ...
    items: [
      { label: "Ancho máximo", value: "Sin límite (con perfiles de refuerzo)" }, 
      { label: "Alto máximo", value: "Sin límite (con perfiles de refuerzo)" }, 
      { label: "Ángulo de apertura", value: "Ninguno (panel fijo sellado)" }, 
      { label: "Espesor de vidrio", value: "6mm / 8mm / 10mm" }
    ] 
  },
  { 
    title: "Perfilería", 
    ...
    items: [
      { label: "Material estructural", value: "Aluminio arquitectónico" }, 
      { label: "Espesor de perfil", value: "1.5 – 2.0 mm" }, 
      { label: "Estilo estético", value: "Con marco / Frameless (sin perfiles)" }, 
  ...
  { 
    ...
    items: [
      { label: "Tipos compatibles", value: "Templado, Crudo o Laminado" }, 
      { label: "Rango de espesores", value: "6mm – 12mm" }, 
      { label: "Estilos de cristal", value: "Transparente / Esmerilado / Reflectivo" }, 
      { label: "Tratamientos extra", value: "Easy Clean / Filtro Solar" }
    ] 
  },
  { 
    title: "Rendimiento", 
...
const APLICACIONES = [
  "Salas y comedores de doble altura (iluminación natural masiva)",
  "Fachadas principales y muros cortina residenciales",
  "Dormitorios de lujo con vistas panorámicas",
  "Tragaluces y áreas de escaleras que no requieren ventilación",
  "Combinación estética junto a paños móviles (proyectantes o batientes)"
];

const FAQ = [
  { 
    pregunta: "¿Cómo se ventila una habitación con ventanas fijas?", 
    respuesta: "La ventana fija está sellada y no posee apertura mecánica, por lo que no brinda ventilación por sí misma. Lo habitual en el diseño arquitectónico es combinar paños fijos de gran tamaño con paños móviles más pequeños (corredizos, proyectantes o batientes) en el mismo ambiente, logrando una iluminación masiva combinada con un flujo de aire adecuado." 
  },
  { 
    pregunta: "¿Son las ventanas fijas más seguras contra roturas e intrusos?", 
    respuesta: "Sí, definitivamente. Al no tener bisagras ni herrajes externos y al ir el cristal templado o laminado firmemente adherido al marco mediante sellado estructural, es el tipo de ventana más difícil de vulnerar o forzar desde el exterior." 
  },
  { 
    pregunta: "¿Qué tipo de cristales se recomiendan usar en las fijas?", 
    respuesta: "Dado que es un panel estático que puede soportar una gran carga de peso, se pueden utilizar cristales más gruesos y pesados. Recomendamos vidrio templado de 8mm o 10mm para áreas estándar, o vidrio laminado de seguridad. También es ideal para instalar doble vidrio (sistemas termoacústicos insulados)." 
  }
];
...
export default function VentanaFijaPage() {
  ...
  const cards = [
    { img: "/images/ventanas/ventana-fija.png", alt: "Diseño Elegante" },
    ...
    <main className="min-h-screen w-full bg-[#0E0B06] overflow-x-hidden flex flex-col">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 flex items-center min-h-screen">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden bg-[#0E0B06]">
          <img 
            src="/images/ventanas/ventana-fija.png" 
            alt="Ventana Fija de Aluminio" 
            ...
            <ScrollReveal staggerChildren={0.15} direction="left" className="flex flex-col items-start">
              ...
              <ScrollRevealItem>
                <Heading level="h1" className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
                  ...
                  <span className="text-[#F59E1B] drop-shadow-[0_0_15px_rgba(245,158,27,0.2)]">Fija</span>
                </Heading>
              </ScrollRevealItem>

              <ScrollRevealItem>
                <p className="text-white/80 text-lg md:text-xl max-w-lg mb-8 leading-relaxed font-light">
                  Máxima entrada de luz y vistas panorámicas espectaculares. Su diseño sin marcos intermedios ni mecanismos móviles ofrece un estilo minimalista puro, garantizando el aislamiento térmico y acústico más eficiente del mercado.
                </p>
              </ScrollRevealItem>
            ...
            <ScrollReveal direction="right" className="relative mt-8 lg:mt-0 flex flex-col items-center">
              ...
              <div className="mt-8 bg-[#140F08]/90 backdrop-blur-md border border-[#F59E1B]/30 p-5 rounded-2xl flex items-center justify-between shadow-2xl w-[85%] max-w-md mx-auto">
                <div>
                  ...
                  <span className="text-white text-3xl font-extrabold tracking-tight">S/. 290</span>
                </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <ScrollReveal direction="up" className="mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-gray-900">
              Lo que incluye tu <span className="text-[#eab308]">Fija</span>
            </Heading>
          </ScrollReveal>
        ...
        <div className="max-w-6xl mx-auto text-center">
          <ScrollReveal direction="up" className="mb-16">
            ...
            <p className="text-white/60 text-lg font-light max-w-2xl mx-auto">
              Detalle estructural y coeficientes de aislamiento termoacústico del panel fijo.
            </p>
          </ScrollReveal>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal direction="up" className="mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-gray-900">
              Ventajas de elegir <span className="text-[#eab308]">Fija</span>
            </Heading>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="text-gray-600 text-xl md:text-2xl mb-12 leading-relaxed font-light max-w-xl">
                La ventana fija es perfecta para diferentes tipos de espacios y necesidades. Descubre si es la opción correcta para tu proyecto.
              </p>
          ...
          <ScrollReveal staggerChildren={0.1} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {GALERIA.map((img, idx) => (
              <ScrollRevealItem key={idx} className="aspect-square md:aspect-[4/3] lg:aspect-square rounded-3xl overflow-hidden group border border-[#2D2110] relative cursor-pointer shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
                <img 
                  src={img} 
                  alt={`Proyecto de ventana fija ${idx + 1}`} 
