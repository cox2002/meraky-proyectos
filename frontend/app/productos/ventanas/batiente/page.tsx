...
const INCLUYE = [
  "Máxima ventilación",
  "Fácil limpieza exterior",
  "Cierre multipunto",
  "Bisagras ocultas",
  "Manija de alta calidad",
  "Sellado perimetral"
];

const VENTAJAS = [
  { 
    title: "Máxima Ventilación", 
    desc: "Al abrir completamente, el 100% del vano queda libre permitiendo una excelente y rápida circulación de aire." 
  },
  { 
    title: "Fácil Limpieza", 
    desc: "Al abrir la hoja hacia afuera, se puede acceder y limpiar el exterior del vidrio cómodamente desde el interior." 
  },
  { 
    title: "Cierre Multipunto", 
    desc: "El sistema de anclaje en múltiples puntos garantiza hermeticidad absoluta y protección frente a intrusos." 
  },
  { 
    title: "Estética Clásica", 
    desc: "Su diseño limpio y atemporal complementa con elegancia cualquier estilo arquitectónico, moderno o rústico." 
  }
];
...
const DATOS = [
  { 
    ...
    items: [
      { label: "Ancho recomendado", value: "40 – 120 cm" }, 
  ...
  { 
    ...
    items: [
      ...
      { label: "Bisagras utilizadas", value: "Acero inoxidable ocultas" }, 
      { label: "Acabados disponibles", value: "Champagne / Natural / Negro" }
    ] 
  },
  { 
    title: "Vidrio", 
    ...
    items: [
      { label: "Tipo de cristal", value: "Crudo o Templado" }, 
      { label: "Espesor estándar", value: "6mm / 8mm" }, 
      { label: "Opciones estéticas", value: "Transparente / Pavonado" }, 
...
const APLICACIONES = [
  "Dormitorios amplios que requieran el máximo de ventilación e iluminación",
  "Salas de estar y áreas sociales principales",
  "Casas de estilo clásico, rústico o colonial",
  "Habitaciones que requieran ventilación completa de pared a pared (apertura 90°/180°)",
  "Ambientes con alta exigencia de hermeticidad y aislamiento acústico al cerrarse"
];

const FAQ = [
  { 
    pregunta: "¿Hacia qué lado se abre la ventana batiente?", 
    respuesta: "Nuestras ventanas batientes se pueden fabricar para abrir tanto hacia adentro (interior) como hacia afuera (exterior), dependiendo del espacio libre con el que cuentes. La apertura hacia afuera es la más recomendada en áreas residenciales para no restar espacio útil a la habitación." 
  },
  { 
    pregunta: "¿Qué ventajas reales ofrece el cierre multipunto?", 
    respuesta: "El sistema multipunto ancla la ventana al marco en 3 a 5 puntos distintos a lo largo del perfil. Esto proporciona un sellado hermético excepcional, impidiendo filtraciones de aire, polvo y lluvia pesada, al tiempo que eleva de forma significativa la seguridad contra intrusos." 
  },
  { 
    pregunta: "¿Es adecuada esta ventana para climas muy lluviosos?", 
    respuesta: "Sí, gracias al uso de burletes perimetrales de EPDM y al ajuste mecánico del cierre multipunto, la ventana batiente ofrece el mayor grado de estanqueidad al agua de su categoría, evitando filtraciones en climas extremos." 
  }
];
...
export default function VentanaBatientePage() {
  ...
  const cards = [
    { img: "/images/ventanas/ventana-batiente-fondo.png", alt: "Diseño Elegante" },
    ...
    <main className="min-h-screen w-full bg-[#0E0B06] overflow-x-hidden flex flex-col">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 flex items-center min-h-screen">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden bg-[#0E0B06]">
          <img 
            src="/images/ventanas/ventana-batiente-fondo.png" 
            ...
            <ScrollReveal staggerChildren={0.15} direction="left" className="flex flex-col items-start">
              ...
              <ScrollRevealItem>
                <p className="text-white/80 text-lg md:text-xl max-w-lg mb-8 leading-relaxed font-light">
                  Apertura lateral mediante bisagras que libera el 100% del vano de la ventana. Ofrece máxima entrada de aire y luz junto a un sistema de cierre multipunto premium que asegura total hermeticidad y protección en tu hogar.
                </p>
              </ScrollRevealItem>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <ScrollReveal direction="up" className="mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-gray-900">
              Lo que incluye tu <span className="text-[#eab308]">Batiente</span>
            </Heading>
          </ScrollReveal>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal direction="up" className="mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-gray-900">
              Ventajas de elegir <span className="text-[#eab308]">Batiente</span>
            </Heading>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="text-gray-600 text-xl md:text-2xl mb-12 leading-relaxed font-light max-w-xl">
                La ventana batiente es perfecta para diferentes tipos de espacios y necesidades. Descubre si es la opción correcta para tu proyecto.
              </p>
