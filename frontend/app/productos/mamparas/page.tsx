...
const TIPOS_MAMPARAS = [
  ...
  {
    title: "Mampara Fija",
    desc: "Un panel de vidrio fijo que separa la ducha. Ideal para baños amplios y modernos.",
    price: "Desde S/ 380",
      ...
      <section className="py-24 px-6 bg-[#FAFAFA] relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            <h3 className="bg-[#FACC15] text-[#110e08] inline-block px-5 py-2 rounded-full text-sm font-bold tracking-[0.2em] uppercase mb-6">Catálogo</h3>
      ...
      <section className="py-24 px-6 bg-white relative">
        <div className="max-w-7xl mx-auto">
          ...
          <ScrollReveal direction="up">
            <div className="bg-gradient-to-r from-[#FACC15] to-[#d4af37] rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl mt-12 text-[#110e08]">
              <div className="text-center md:text-left">
                <div className="text-4xl md:text-5xl font-extrabold mb-2">NTP 399</div>
                <div className="font-semibold text-[#110e08]/80 uppercase tracking-wider text-sm">Norma Técnica Peruana</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="font-semibold text-[#110e08]/80 uppercase tracking-wider text-sm">Más resistente que vidrio común</div>
              </div>
              <div className="hidden md:block w-px h-16 bg-[#110e08]/20"></div>
              <div className="text-center md:text-right">
                <div className="text-4xl md:text-5xl font-extrabold mb-2">100%</div>
                <div className="font-semibold text-[#110e08]/80 uppercase tracking-wider text-sm">Vidrio de seguridad</div>
              </div>
            </div>
          </ScrollReveal>
        </div>
