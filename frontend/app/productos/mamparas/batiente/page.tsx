...
const PRECIOS = [
  { material: "Serie 35 (Estándar)", precio: "S/ 600.00", badge: "DESDE" },
  { material: "Serie 72 (Premium)", precio: "S/ 990.00" },
];
...
const VENTAJAS = [
  ...
  },
  {
    ...
    desc: "Apertura total de 180° que facilita la entrada y limpieza del espacio."
  },
  {
    icon: (
    ...
    desc: "Sistema magnético hermético que evita filtraciones y salpicaduras."
  },
  {
    icon: (
...
const APLICACIONES = [
  "Baños amplios y residenciales",
  "Diseños modernos y de lujo",
  "Hoteles boutique y suites",
  "Personas con movilidad reducida",
  "Duchas walk-in con puerta batiente"
];

const GALERIA = [
  "/images/mamparas/mampara-batiente-usuario.png",
  "/images/mamparas/mampara-batiente-final.png",
  "/images/mamparas/mampara-batiente-proceso.png",
  "/images/mamparas/mampara-batiente-fondo.png",
  "/images/mamparas/mampara-batiente-galeria-1.png",
  "/images/mamparas/mampara-batiente-galeria-2.png",
  "/images/mamparas/mampara-batiente-galeria-3.png",
  "/images/mamparas/mampara-batiente-galeria-4.png"
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal staggerChildren={0.15} direction="left" className="flex flex-col items-start">
              ...
              <ScrollRevealItem>
                <Heading level="display" className="text-white drop-shadow-2xl font-display font-bold text-4xl sm:text-5xl lg:text-[54px] leading-[1.1] mb-6 tracking-tight">
                  Mampara <span className="text-[#F59E1B] drop-shadow-[0_0_15px_rgba(245,158,27,0.15)]">Batiente</span> <br className="hidden md:block" />
                  <span className="text-white/90 text-2xl sm:text-3xl lg:text-[32px] font-sans font-medium block mt-3 leading-tight">
                    Elegancia clásica con apertura total
                  </span>
                </Heading>
              </ScrollRevealItem>
            ...
            <ScrollReveal direction="right" className="relative mt-8 lg:mt-0 font-sans w-full max-w-[440px] lg:max-w-[480px] mx-auto z-20">
              ...
              <div className="mb-4 transition-transform duration-700 hover:scale-[1.01]">
                <img
                  src="/images/mamparas/mampara-batiente-usuario.png"
                  alt="Instalación de Mampara Batiente"
        ...
        <div className="max-w-5xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">
              Lo que incluye tu <span className="text-[#F59E1B]">Batiente</span>
            </Heading>
          </ScrollReveal>
      ...
      <section className="py-20 px-4 sm:px-6 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">Información detallada de ingeniería sobre materiales, dimensiones y resistencia del sistema batiente.</p>
          </ScrollReveal>
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#0E0B06] relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">
              Ventajas de elegir <span className="text-[#F59E1B]">Batiente</span>
            </Heading>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal direction="left">
              ...
              <p className="text-gray-600 text-lg mb-10 leading-relaxed font-light max-w-lg">
                La mampara batiente es perfecta para espacios amplios donde se busca un diseño clásico y un acceso total:
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <ScrollReveal direction="up">
            <Heading level="h2" className="text-3xl md:text-5xl font-bold text-white mb-6">
              ¿Listo para renovar con una <span className="text-[#F59E1B]">Batiente</span>?
            </Heading>
