...
const DATOS_TECNICOS = [
  {
    ...
    title: "Dimensiones",
    items: [
      { label: "Ancho", value: "60 - 140 cm" },
      { label: "Alto estándar", value: "200 cm" },
      { label: "Alto máximo", value: "220 cm" },
      { label: "Espacio de paso", value: "Mínimo 50 cm" },
    ]
  },
  {
    icon: (
    ...
    items: [
      ...
      { label: "Espesor recomendado", value: "10mm / 12mm" },
      { label: "Acabados", value: "Transparente, Pavonado, Serigrafiado" },
      { label: "Bordes", value: "Pulidos perimetrales" },
    ]
  },
  {
    icon: (
    ...
    title: "Soportes",
    items: [
      { label: "Tipo", value: "Barra estabilizadora" },
      { label: "Material", value: "Acero inoxidable 304" },
      { label: "Fijación pared", value: "Perfil oculto o visible" },
      { label: "Acabados", value: "Cromo, Negro, Dorado" },
    ]
  },
  {
    icon: (
    ...
    items: [
      { label: "Perfilería", value: "Mínima o sin perfil" },
      { label: "Sellado", value: "Silicona transparente" },
      { label: "Limpieza", value: "Súper fácil" },
...
const PRECIOS = [
  { nombre: "Moduglas", precio: "380.00", destacada: true },
  { nombre: "Enmarcado", precio: "450.00", destacada: false }
];
...
const VENTAJAS = [
  {
    ...
    desc: "Un panel de vidrio simple que nunca pasa de moda y se adapta a cualquier estilo arquitectónico."
  },
  {
    icon: (
    ...
    desc: "Al no tener rieles ni bisagras, la limpieza es increíblemente rápida y sencilla."
  },
  {
    icon: (
    ...
    title: "Accesibilidad",
    desc: "Ideal para un concepto de ducha walk-in, perfecto para personas con movilidad reducida."
  },
  {
    icon: (
    ...
    desc: "La ausencia de partes móviles significa que prácticamente no sufre desgaste con el uso diario."
  }
];
...
const FAQ = [
  {
    pregunta: "¿No salpica agua fuera de la ducha?",
    respuesta: "No, siempre y cuando se dimensione correctamente. Recomendamos un ancho mínimo para el panel fijo y asegurarnos de que la caída de agua (desagüe) tenga la pendiente adecuada. Con estas consideraciones técnicas, el agua se mantendrá en la zona de ducha."
  },
  {
    pregunta: "¿Qué espesor de vidrio se recomienda?",
    respuesta: "Para mamparas fijas, al estar sujetas solo por un lado y la base, recomendamos siempre cristales templados de 10mm o 12mm de espesor. Esto garantiza la rigidez estructural necesaria y brinda total seguridad ante posibles impactos."
  },
  {
    pregunta: "¿Se necesita barra estabilizadora?",
    respuesta: "Sí, en el 90% de los casos. La barra estabilizadora (que va del vidrio a la pared opuesta) es fundamental para evitar la vibración del panel y darle firmeza estructural. Solo en casos donde el vidrio va encastrado al techo se podría omitir."
  }
];

export default function MamparaFijaPage() {
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <ScrollReveal direction="left" className="max-w-3xl">
            ...
            <Heading level="h1" className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-4">
              Mampara <span className="text-[#FACC15]">Fija</span>
            </Heading>
            
            <h2 className="text-[#FACC15] md:text-xl font-medium mb-6">
              <span className="text-white/90">Minimalismo y elegancia contemporánea</span>
            </h2>

            <p className="text-white/70 text-lg leading-relaxed mb-10 max-w-2xl font-light">
              Las mamparas fijas, también conocidas como walk-in, representan la máxima expresión del diseño minimalista en baños. Consisten en un panel de vidrio fijo que separa la zona de ducha sin necesidad de puerta. Este diseño abierto crea una sensación de amplitud y facilita el acceso, siendo ideal para baños modernos y personas con movilidad reducida.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <div className="bg-[#16130c]/80 backdrop-blur-sm border border-[#2a2415] rounded-full px-6 py-3 flex items-center gap-3">
                ...
                <span className="text-white font-extrabold text-lg">S/ 380</span>
              </div>
              <div className="bg-[#16130c]/80 backdrop-blur-sm border border-[#2a2415] rounded-full px-6 py-3 flex items-center gap-3">
                ...
                <span className="text-white/90 text-sm font-medium">1.5-2 horas</span>
              </div>
              <div className="bg-[#16130c]/80 backdrop-blur-sm border border-[#2a2415] rounded-full px-6 py-3 flex items-center gap-3">
                <svg className="w-5 h-5 text-white/50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                <span className="text-white/90 text-sm font-medium">5 años en vidrio, 2 años en soportes</span>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-[#16130c] relative">
        <div className="max-w-4xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <div className="inline-flex items-center gap-2 bg-[#0c0a07] border border-[#FACC15]/30 text-white px-5 py-2.5 rounded-full text-sm font-medium mb-4 shadow-[0_0_15px_rgba(250,204,21,0.05)]">
              <svg className="w-4 h-4 text-[#FACC15]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.121 14.121L19 19m-7-7l7-7m-7 7l-2.879 2.879M12 12L9.121 9.121m0 5.758a3 3 0 10-4.243 4.243 3 3 0 004.243-4.243zm0-5.758a3 3 0 10-4.243-4.243 3 3 0 004.243 4.243z" /></svg>
              Medida de referencia: 1.50m × 2.50m
            </div>
          ...
          <ScrollReveal staggerChildren={0.1} className="space-y-4">
            {PRECIOS.map((item, idx) => (
              <ScrollRevealItem key={idx}>
                <div className={`bg-[#0c0a07] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all duration-300 ${item.destacada ? 'border border-[#FACC15]/50 shadow-[0_0_20px_rgba(250,204,21,0.1)]' : 'border border-[#2a2415] hover:border-[#FACC15]/30'}`}>
                  <div className="flex items-center gap-4">
                    ...
                    <h4 className="text-xl md:text-2xl font-bold text-white">{item.nombre}</h4>
                  </div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-[#FACC15] font-bold text-2xl md:text-3xl">S/ {item.precio}</span>
                  </div>
                </div>
              </ScrollRevealItem>
            ))}
          ...
          <p className="text-center text-white/40 text-xs mt-8 font-light max-w-2xl mx-auto">
            * Los precios incluyen materiales e instalación. Pueden variar según las medidas y acabados elegidos.
          </p>
        </div>
      </section>

      {/* Lo que incluye tu Fija */}
        ...
        <div className="max-w-5xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-white">
              Lo que incluye tu <span className="text-[#FACC15]">Fija</span>
            </Heading>
          </ScrollReveal>
      ...
      <section className="py-24 px-6 bg-[#0c0a07] relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-4xl md:text-5xl font-bold text-white">
              Ventajas de elegir <span className="text-[#FACC15]">Fija</span>
            </Heading>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="text-white/70 text-lg mb-10 leading-relaxed font-light max-w-lg">
                La mampara fija es perfecta para diferentes tipos de espacios y necesidades. Descubre si es la opción correcta para tu proyecto.
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <ScrollReveal direction="up">
            <Heading level="h2" className="text-3xl md:text-5xl font-bold text-white mb-6">
              ¿Listo para tu nueva <span className="text-[#FACC15]">Fija</span>?
            </Heading>
