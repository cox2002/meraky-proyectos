...
const PRECIOS = [
  { material: "Moduglas Fijo (Estándar)", precio: "S/ 599.00", badge: "DESDE" },
  { material: "Templado 10mm (Premium)", precio: "S/ 780.00" },
];
...
const VENTAJAS = [
  ...
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" /></svg>
    ),
...
const APLICACIONES = [
  "Baños de diseño moderno",
  "Duchas walk-in premium",
  "Accesibilidad para movilidad reducida",
  "Espacios minimalistas contemporáneos",
  "Hoteles boutique y resorts"
];

const GALERIA = [
  "/images/mamparas/mampara-fija-usuario.png",
  "/images/mamparas/mampara-fija-galeria-1.png",
  "/images/mamparas/mampara-fija-galeria-2.png",
  "/images/mamparas/mampara-fija-galeria-3.png"
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal staggerChildren={0.15} direction="left" className="flex flex-col items-start">
              ...
              <ScrollRevealItem>
                <Heading level="display" className="text-white drop-shadow-2xl font-display font-bold text-4xl sm:text-5xl lg:text-[54px] leading-[1.1] mb-6 tracking-tight">
                  Mampara <span className="text-[#F59E1B] drop-shadow-[0_0_15px_rgba(245,158,27,0.15)]">Fija</span> <br className="hidden md:block" />
              ...
              <ScrollRevealItem>
                <p className="font-sans font-normal text-white/95 text-sm sm:text-[15px] leading-relaxed max-w-[500px] mb-8">
                  Las mamparas fijas, también conocidas como walk-in, representan la máxima expresión del diseño minimalista en baños. Consisten en un panel de vidrio fijo que separa la zona de ducha sin necesidad de puerta. Este diseño abierto crea una sensación de amplitud y facilita el acceso.
                </p>
              </ScrollRevealItem>
            ...
            <ScrollReveal direction="right" className="relative mt-8 lg:mt-0 font-sans w-full max-w-[440px] lg:max-w-[480px] mx-auto z-20">
              ...
              <div className="mb-4 transition-transform duration-700 hover:scale-[1.01]">
                <img
                  src="/images/mamparas/mampara-fija-usuario.png"
                  alt="Instalación de Mampara Fija"
        ...
        <div className="max-w-4xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <div className="inline-flex items-center gap-2 bg-white border border-gray-200 px-4 py-2 rounded-full text-gray-600 text-sm mb-4 shadow-sm">
              ...
              Medida de referencia estándar: 1.50m × 2.50m
            </div>
          ...
          <ScrollReveal staggerChildren={0.1} direction="up" className="space-y-4">
            {PRECIOS.map((item, idx) => (
              <ScrollRevealItem key={idx}>
                <div className={`bg-white border ${item.badge ? 'border-[#F59E1B] shadow-[0_8px_30px_rgba(245,158,27,0.08)]' : 'border-gray-200 hover:border-[#F59E1B]/40'} transition-all duration-300 rounded-2xl p-6 flex items-center justify-between shadow-sm`}>
        ...
        <div className="max-w-5xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">
              Lo que incluye tu <span className="text-[#F59E1B]">Fija</span>
            </Heading>
          </ScrollReveal>
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#0E0B06] relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <Heading level="h2" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">
              Ventajas de elegir <span className="text-[#F59E1B]">Fija</span>
            </Heading>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal direction="left">
              ...
              <p className="text-gray-600 text-lg mb-10 leading-relaxed font-light max-w-lg">
                La mampara fija ofrece una solución de diseño walk-in limpia, moderna y de fácil accesibilidad:
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <ScrollReveal direction="up">
            <Heading level="h2" className="text-3xl md:text-5xl font-bold text-white mb-6">
              ¿Listo para tu nueva <span className="text-[#F59E1B]">Fija</span>?
            </Heading>
            <p className="text-white/70 text-lg mb-10 leading-relaxed max-w-2xl mx-auto font-sans">
              Solicita una cotización gratuita y sin compromiso. Nuestro equipo de soporte técnico te responderá en menos de 24 horas.
            </p>
